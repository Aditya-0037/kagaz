...
EXPECTED_FIELDS = {"name", "father_name", "dob", "certificate_no", "address", "issue_date", "valid_until"}
...
certificate_no, address (the residential address this certificate
establishes, if printed), issue_date (as written), and valid_until (the
"Valid Until" field, as written).
